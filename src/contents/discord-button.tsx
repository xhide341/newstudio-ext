import cssText from "data-text:~/contents/discord-button.css"
import type { PlasmoCSConfig, PlasmoGetInlineAnchor } from "plasmo"
import type React from "react"

import "./discord-button.css"
...
export const getInlineAnchor: PlasmoGetInlineAnchor = async () => {
  const iconsSection = document.querySelector(
    ".right-section-content .icons-section"
  )
  const helpWidget = iconsSection?.querySelector("#help-widget")
  if (iconsSection && helpWidget) {
    return {
      element: helpWidget,
      insertPosition: "beforebegin"
    }
  }
  console.error("failed to inject discord button")
  return null
}
...
const DiscordButton: React.FC<DiscordButtonProps> = ({
  discordUrl = "https://discord.newstudio.app/"
}) => {
  const handleClick = () => {
